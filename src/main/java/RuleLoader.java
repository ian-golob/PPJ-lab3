...
public class RuleLoader {
    ...
    private static final NumericType INT = NumericType.INT;
    private static final NumericType CHAR = NumericType.CHAR;
    ...
    public void loadRules(){
        ...
        addRule("<primarni_izraz>", List.of(
            ...
            ConstantUtil.requireIntValue(BROJ.getSourceText());
        ...
        addRule("<primarni_izraz>", List.of(
            ...
            ConstantUtil.requireValidChar(ZNAK.getSourceText());
        ...
        addRule("<primarni_izraz>", List.of(
            ...
            ConstantUtil.requireValidString(NIZ_ZNAKOVA.getSourceText());
        ...
        addRule("<ime_tipa>", List.of(
            ...
            node.setProperty("tip", NumericType.constOf((DataType) specifikator_tipa.getProperty("tip")));
        });
        ...
        addRule("<izravni_deklarator>", List.of(
            ...
            ConstantUtil.requireArraySize(broj.getSourceText());
